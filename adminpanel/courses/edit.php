...
<div class="container mainContent">
    <div class="row">
        ...
        <div class="row content">
            <div class="col-md-10">
                <form action="adminpanel/courses/update.php" method="post">
                    <input type="hidden" name="id" value="<?=$_GET['id']?>">
                    <div class="form-group">
                        <label for="name">course Name:</label>
                        <input class="form-control" name="name" id="name" type="text" value="<?=$course[0]['name']?>">
                    </div>
                    <div class="form-group">
                        <label for="course_code">Course code:</label>
                        <input class="form-control" name="course_code" id="course_code" type="text" value="<?=$course[0]['course_code']?>">
                    </div>
                    <div class="form-group">
                        <label for="course_details">Course Details:</label>
                        <input class="form-control" name="course_details" id="course_details" type="text" value="<?=$course[0]['course_details']?>">
                    </div>
