...
<div class="container mainContent">
    <div class="row">
        ...
        <div class="row content">
            <div class="col-md-10">
                <?php
                      echo "<h3>First Name    = ".$student[0]['first_name']."</h3>";
                      echo "<h3>Last Name     = ".$student[0]['last_name']."</h3>";
                      echo "<h3>Schools Id    = ".$student[0]['school_id']."</h3>";
                      echo "<h3>Fathers  Name = ".$student[0]['fathers_name']."</h3>";
                      echo "<h3>mothers  Name = ".$student[0]['mothers_name']."</h3>";
                      echo "<h3>contact       = ".$student[0]['contact_number']."</h3>";
                ?>
            </div>
        </div>
        <footer>
